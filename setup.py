...
ext_modules=[
#    Extension("isu.crm.cython_module",
#              sources=["src/./isu.crm/cython_module.pyx"],
#              libraries=["gdal"],
#    )
]
...
setup(
    name='isu.crm',
    version=version,
    description="CRM oriented to real estate market",
    ...
    #     """.split('\n') if c.strip()],
    # ],
    keywords='CRM recommender system',
    author='Evgeny Cherkashin',
    author_email='eugeneai@irnok.net',
    url='https://github.com/isu-enterprise/istu.crm',
    license='GPL-3.0',
    packages=find_packages("src"),
    package_dir = {'': "src"},
    namespace_packages = ['istu'],
